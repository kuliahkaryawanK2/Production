          ...
          <div class="row">
            <div class="col-lg-12 align-self-center">
              <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                ...
                <p>Jasa Marketing merupakan bidang jasa yang menyediakan beberapa layanan untuk memasarkan produk produk anda. Ada beberapa layanan yang kami sediakan contohnya, Design Social Media, Digital Marketing, Web Design, Branding. Yuk buruan konsultasikan bisnis kamu di <a rel="nofollow" href="" target="_parent">Jasa Marketing</a>.</p>
              </div>
            </div>
            <!-- <div class="col-lg-6">
        ...
        <div class="pt-5 pb-3 d-lg-flex align-items-center gx-5">
            ...
            <div class="col-lg-3">
                ...
                <p class="text-muted light-300">
                    Berikut Tim Kami dari bidang Website dan Design.
                </p>
            </div>
      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading  wow bounceIn" data-wow-duration="1s" data-wow-delay="0.2s">
            <h2>Alur<span> Kerja Sama</span></h2>
          </div>
        </div>
      </div>
  </div>
...
<!-- Item 1 -->
  	<li>
		<div class="direction-l">
			...
			<div class="desc">Konsultasikan Bisnis Anda</div>
		</div>
	</li>
	...
	<li>
		<div class="direction-r">
			...
			<div class="desc">Meeting Client</div>
		</div>
	</li>
	...
	<li>
		<div class="direction-l">
			...
			<div class="desc">Tahap Pengerjaan</div>
		</div>
	</li>
	...
	<li>
		<div class="direction-r">
			...
			<div class="desc">Quality Assurance and Checking Project
</div>
		</div>
	</li>
  ...
  <li>
		<div class="direction-l">
			...
			<div class="desc">Project Selesai</div>
		</div>
	</li>
