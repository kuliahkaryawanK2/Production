    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Update Data Blog</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/admin">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="/data-blog">Data Blog</a></li>
                            <li class="breadcrumb-item active">Update Data Blog</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Update Data Blog</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="{{route('updateDataBlog',$dataBlog->id)}}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea
                                                        class="form-control @error('judul_short') is-invalid @enderror"
                                                        rows="3"
                                                        placeholder="Enter ..." name="judul_short">
                                                   {{ $dataBlog->judul_short }}
                                                </textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="filtr-item col-sm-6" data-category="1"
                                                ...
                                                <a href="{{ url('/blog'). "/".$dataBlog->image }}"
                                                   data-toggle="lightbox" data-title="sample 1 - white">
                                                    <img src="{{ url('/blog'). "/".$dataBlog->image }}"
                                            ...
                                            <div class="custom-file">
                                                <input name="image" type="file"
                                                       ...
                                                       id="customFile" value="{{ $dataBlog->image }}">
